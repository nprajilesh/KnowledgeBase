...
$(function () {
	...
	guidely.add ({
		attachTo: '#target-4'
		, anchor: 'top-left'
		, title: 'Sharing Presentations made easy'
		, text: 'Add presentation to the courses you are teaching. <br/>Upload to drive and share the link here . <br /><img src="img/p_link.png">'
	});
