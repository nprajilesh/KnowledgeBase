...
%></h3>
	...
	PersistenceManager pm2 = PMF.get().getPersistenceManager();
			try
			{
				...
				{
					int i =1;
					for(com.kbase.app.server.Presentation v : result)
					{
						%>
						<div class="span6">					
							<div class="widget">
						
						<% out.print(i+")  "+v.getPresentname()); i++;%> <a href="deletepresentation.jsp?id=<% out.print(v.getId());%>" style="margin-left:60%;">Remove</a>
						</div><iframe src="https://docs.google.com/presentation/d/<% out.print(v.getPresentId()); %>/embed?start=false&loop=false&delayms=3000" frameborder="0" width="480" height="389" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>
